    ...
    <div className="product">
      <div className="container">
        <div className="product__txt" data-aos="fade-left" data-aos-duration="2300">
          ...
          <Link to="#" className="btn">Find Your Way</Link>
        </div>
        <div className="product__wrapper">
          <div className="product__img" >
            <img className="product__img__el" src="asset/images/dummy/Image1.jpg" data-aos="fade-up" data-aos-duration="1700" alt="product_of_the_image_profile" />
          </div>
          <div className="product__thumbnail" data-aos="fade-up-right" data-aos-duration="18000">
            ...
            <img className="thumbnail-img" src="asset/images/dummy/Image1.jpg" alt="product img profile"/>
